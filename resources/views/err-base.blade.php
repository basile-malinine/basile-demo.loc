...
<main class="flex-shrink-0">
    <div class="container">
        ...
        <div class="static-text">
            ...
            <br>
            <h4>Общее:</h4>
            <p>Можно (но не обязательно) использовать любой фреймворк, как для бэка, так и для фронта.</p>
            <h4>Суть задачи:</h4>
        ...
        <div class="static-text">
            <h4>Для реализации использовал:</h4>
            <ul>
                <li>PHP 8</li>
                <li>Laravel 9</li>
                <li>Bootstrap 5</li>
            ...
            <h4>Корневой WEB-каталог:</h4>
            <p class="fw-bold">basile-demo.loc/</p>
            <h4 class="text-danger">Для запуска приложения необходимо:</h4>
            <ul>
